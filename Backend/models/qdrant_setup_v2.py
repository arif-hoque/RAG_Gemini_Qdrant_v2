...
def add_documents_to_collection(collection_name, qdrant_client, chunk_size=2000, overlap=100):
    try:
...
# Example usage
# add_documents_to_collection("Gigalogy Data 2", qdrant_client, chunk_size=1000, overlap=0)